...
export default function broadcast(client, MessageType, Mimetype) {
    ...
    setInterval(async function(){ 
        ...
        const time_adhkar_all = ["1:00 PM","6:00 PM","9:00 PM","12:00 PM"]
        const time_video = ["3:00 PM","7:00 PM","1:00 AM","4:00 AM"]
        const time_photo = ["7:00 AM","10:00 AM","8:00 AM","12:00 AM"]
        const time_quran = ["9:00 AM","11:00 AM","10:00 PM","3:00 AM"]
